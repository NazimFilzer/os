...
int isSafe(int allocation[Max_Process][Max_Resources],int max[Max_Process][Max_Resources],int need[Max_Process][Max_Resources],int available[Max_Resources],int n,int m){
